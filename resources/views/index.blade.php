...
<html lang="en">
  <head>
    ...
    <title>Portfolio (Rakesh Basnet)</title>
<!--
Reflux Template
  ...
  <body>
    <div id="page-wraper">
      ...
      <div class="responsive-nav">
        ...
        <div id="menu" class="menu" style="background-color:darkslategray ">
          <i class="fa fa-times" id="menu-close"></i>
          <div class="container">
            <div class="image">
              <a href="#"><img src="assets/images/mypp.jpg" alt="" /></a>
            </div>
            ...
            <div class="social-network">
              <ul class="soial-icons">
                <li>
                  <a href="https://www.facebook.com/rakesh.basnet.967" target="_blank"
                    ><i class="fa fa-facebook"></i
                  ></a>
                </li>
                <li>
                  <a href="https://twitter.com/Raq_ashBasnet" target="_blank"><i class="fa fa-twitter"></i></a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/rakeshbasnet/" target="_blank"><i class="fa fa-linkedin"></i></a>
                </li>
                <li>
                  <a href="https://github.com/rakeshbasnet" target="_blank"><i class="fa fa-github"></i></a>
                </li>
                <li>
                  <a href="https://www.instagram.com/rakeshbasnet086/" target="_blank"><i class="fa fa-instagram"></i></a>
                </li>
              </ul>
            </div>
            <div class="copyright-text">
              <p>© Copyright MyPortfolio 2021 by Rakesh Basnet</p>
            </div>
          </div>
        </div>
      </div>
